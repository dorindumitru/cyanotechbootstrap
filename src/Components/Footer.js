...
const Footer = (props) => {
  ...
  return (
    <div
      ...
      <Card
        className='d-flex flex-column text-center rounded w-50'
        ...
        <div className='p-4'>
          <a
            ...
            target='_blank'
            rel='noreferrer'>
            <Card.Img src={facebook} alt='facebook' className='w-25 p-3' />
          </a>
          <a
            href='https://twitter.com/CyanotechEurope'
            target='_blank'
            rel='noreferrer'>
            <Card.Img src={twitter} alt='twitter' className='w-25 p-3' />
          </a>
          <a
            href='https://www.linkedin.com/company/cyanotechromania'
            target='_blank'
            rel='noreferrer'>
            <Card.Img src={linkedin} alt='linkedin' className='w-25 p-3' />
          </a>
          <a
            href='https://www.youtube.com/channel/UCWh6iAsBNQooHktqQy7vOog'
            target='_blank'
            rel='noreferrer'>
            <Card.Img src={youtube} alt='youtube' className='w-25 p-3' />
          </a>
        </div>
      </Card>
      <Form
