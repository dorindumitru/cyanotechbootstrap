...
const Footer = (props) => {
  ...
  return (
    <div
      ...
      className={
        props.darkmode === "Dark"
          ? "d-flex flex-column flex-md-row justify-content-center align-items-center w-100 bg-light"
          : "d-flex flex-column flex-md-row justify-content-center align-items-center w-100 bg-dark"
      }>
      <div>
        <Form
          onSubmit={sendEmail}
